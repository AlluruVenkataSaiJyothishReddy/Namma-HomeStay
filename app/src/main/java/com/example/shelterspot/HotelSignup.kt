...
import com.example.shelterspot.databinding.ActivityHotelSignupBinding

class HotelSignup : AppCompatActivity() {

    private lateinit var binding: ActivityHotelSignupBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityHotelSignupBinding.inflate(layoutInflater)
