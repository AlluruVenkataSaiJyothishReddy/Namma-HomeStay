...
public final class FragmentBookBinding implements ViewBinding {
  ...
  private FragmentBookBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView recycler,
  ...
  public static FragmentBookBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBookBinding((ConstraintLayout) rootView, recycler, searchCity, searchbtn);
    }
